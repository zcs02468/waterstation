    ...
    <div class="panel-bodyer">
      <div class="panel-top body-content">
        ...
        <div class="content-body">
          ...
          <div class="water-box-content">
            <div class="water-box">
              <Box :textType="waterList[0].isOverproof" :num="waterList[0].value" />
              <div class="title">东泵站</div>
            </div>
            <div class="water-box">
              <Box :textType="waterList[1].isOverproof" :num="waterList[1].value" />
              <div class="title">迎宾三路</div>
            </div>
            <div class="water-box">
              <Box :textType="waterList[2].isOverproof" :num="waterList[2].value" />
              <div class="title">南调东侧</div>
            </div>
            <div class="water-box">
              <Box :textType="waterList[3].isOverproof" :num="waterList[3].value" />
              <div class="title">南调西侧</div>
            </div>
            <div class="water-box">
              <Box :textType="waterList[4].isOverproof" :num="waterList[4].value" />
      ...
      <div class="panel-top body-content">
        ...
        <div class="content-body">
          ...
          <div class="water-box-content">
            <div class="water-box">
              <Box :textType="waterList[5].isOverproof" :num="waterList[5].value" />
              <div class="title">东泵站</div>
            </div>
            <div class="water-box">
              <Box :textType="waterList[6].isOverproof" :num="waterList[6].value" />
              <div class="title">北水塔</div>
            </div>
            <div class="water-box">
              <Box :textType="waterList[7].isOverproof" :num="waterList[7].value" />
              <div class="title">北调东侧</div>
            </div>
            <div class="water-box">
              <Box :textType="waterList[8].isOverproof" :num="waterList[8].value" />
              <div class="title">北调西侧</div>
            </div>
            <div class="water-box">
              <Box :textType="waterList[9].isOverproof" :num="waterList[9].value" />
      ...
      <div class="panel-top body-content">
        ...
        <div class="content-body">
          ...
          <div class="water-box-content" style="justify-content: flex-start;">
            <div class="water-box">
              <Box :textType="waterList[10].isOverproof" :num="waterList[10].value" boxType="111111"/>
              <div class="title text-center">友乐路泵站</div>
            </div>
            <div class="water-box end-water-content-box">
              <Box :textType="waterList[11].isOverproof" :num="waterList[11].value" boxType="111111"/>
              <div class="title text-center">外环西河（雨水）友乐路泵站雨水</div>
            </div>
          </div>
        </div>
      </div>
