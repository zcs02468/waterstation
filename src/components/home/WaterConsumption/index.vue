        ...
        <div class="warp-container">
            <div class="panel-content">
                ...
                <div class="chart-box">
                    ...
                    <div class="sum">总量：{{consumptionArr[selectIndex].allSum}}m²</div>
                </div>
            </div>
        </div>
        <div class="tip">
